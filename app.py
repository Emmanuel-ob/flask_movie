...
from flask.ext import Security, SQLAlchemyUserDataStore, UserMixin, RoleMixin, login_required

app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:@localhost/flaskmovie'
